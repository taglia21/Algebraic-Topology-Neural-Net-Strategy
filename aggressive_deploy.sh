#!/bin/bash
#===============================================================================
# AGGRESSIVE PAPER TRADING - FAST PROFIT MODE
# For demonstration purposes - shows P&L quickly
# Created: 2026-02-02
#===============================================================================
...
echo "🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥"
echo "       AGGRESSIVE MODE - PAPER TRADING"
echo "       Maximum profit extraction enabled"
echo "🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥"
echo ""

export PAPER_TRADING=true
export AGGRESSIVE_MODE=true
export TRADING_INTERVAL=30

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
cd "$SCRIPT_DIR"

# Kill existing traders
pkill -f "paper_trading" 2>/dev/null || true
pkill -f "aggressive_trader" 2>/dev/null || true
sleep 2

echo "[1] Creating aggressive trader..."

cat > aggressive_trader.py << 'PYTHON_SCRIPT'
#!/usr/bin/env python3
"""
...
chmod +x aggressive_trader.py

echo ""
echo "[2] Starting aggressive trader..."
echo ""

python3 aggressive_trader.py 2>&1 | tee aggressive_trading.log
